...
@if (Sentinel::getUser()->hasAccess(['product.store']))
...
<div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body">
        <!--begin: Datatable -->
        <table class="table table-striped- table-bordered table-hover table-checkable" id="tbl_product">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Product Name</th>
...
{!! Form::open(['method'=>'DELETE', 'route' => ['product.destroy', 0], 'style' => 'display:inline','id'=>'form-delete'])
!!}
{!! Form::close() !!}
@stop
...
<script type="text/javascript">
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    ...
                    data + `,'` + full.name + `')">@lang('global.app_edit') {{$name}}</a>` +
                        @endif
                    @if(Sentinel::getUser()->hasAccess(['product.destroy']))
                    ` <a class="btn btn-danger btn-sm" onclick="delete_product(` + data +
    ...
    function delete_product(id) {
        swal.fire({
            ...
            if (result.value) {
                ...
                $('#form-delete').attr('action', "{{route('product.index')}}/" + id);
                $('#form-delete').submit();
    ...
    function edit(id, name) {
        if ($('#edit').is(":visible") && id == id_awal) {
            ...
            $('#edit').show('500');
            $('#e_name').val(name);
            $('#form-update').attr('action', "{{route('product.index')}}/" + id);
        }
