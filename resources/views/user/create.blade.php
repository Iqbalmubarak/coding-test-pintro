...
<div class="btn-group">
  <button type="button" class="btn btn-primary btn-bold" onclick="$('#user_create_f').click()">
            ...
            <div class="kt-form kt-form--label-right">
              <div class="kt-form__body">
                ...
                <div class="text-center">
                  <button class="btn btn-primary btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u" type="submit" name="button" id="user_create_f">
                    @lang('global.app_save')
                  </button>
                </div>
              </div>
